...
public class MinHeap <T extends Comparable<T>>
{
	...
	//This preserves the data structure after adding
	...
	//This removes the top/next thing in the heap
	public T remove()
	{
		if(lastIndex == 0)
			return null;
	...
	//This preserves the data structure after removing
	...
	//Prints the complete heap (NOT USED IN CURRENT)
	public void print()
	{
		for(T h : heap)
		{
	...
	//This sorts the heap (NOT USED IN CURRENT)
